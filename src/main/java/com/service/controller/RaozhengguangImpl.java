...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-17T13:42:16.168Z")

@RestSchema(schemaId = "raozhengguang")
@RequestMapping(path = "/csetest001", produces = MediaType.APPLICATION_JSON)
